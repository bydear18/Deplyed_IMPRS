...
const Hometab = () => {
    ...
    const handleEdit = () => {
        ...
        if (!editing) {
            ...
            fetch("https://backimps-production.up.railway.app/services/updateHomeDetails", requestOptions)
    ...
    useEffect(() => {
        ...
        if (!editing) {
            fetch("https://backimps-production.up.railway.app/services/getHomeDetails", requestOptions)
