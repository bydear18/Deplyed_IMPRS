...
const Login = () => {
    ...
    const handleLogin = () => {
      ...
      fetch("backimps-production.up.railway.app/services/userLogin?email=" + email + "&password=" + password, requestOptions)
          ...
          .then((data) => {
              if (data.status === true) {
                  ...
                  fetch("backimps-production.up.railway.app/services/getname?email=" + email, requestOptions)
                      .then((response) => response.json())
                      .then((data) => {
                          ...
                          fetch("backimps-production.up.railway.app/services/getid?email=" + email, requestOptions)
                          .then((response) => response.json())
                          .then((data) => {
